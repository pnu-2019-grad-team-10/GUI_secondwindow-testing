...
class MyApp(QWidget):
    ...
    def initUI(self, MainWindow): 
        ...
        self.title = QtWidgets.QLabel('Keystroke Dynamics Analytics')   #화면 Title
        self.title.setAlignment(Qt.AlignCenter)     

        self.font_t = self.title.font()                   #폰트 설정
        self.font_t.setFamily('Times new Roman')
        self.font_t.setBold(True)
        self.font_t.setPointSize(14)
        
        self.title.setFont(self.font_t)

        self.text = QTextBrowser(self)
        self.text.setText( "                                                * Keystroke Dynamics Analytics *\n\n혈중 알코올 농도에 따른 타자 패턴 분석 도구입니다.\n\n배부된 타자 연습 입력 결과 로그를 제출해주세요.\n\n\n\n\n\n\n                                                                                 - 부산대학교 2019년도 전기 졸업과제 10조")
        ...
        self.uploadButton = QtWidgets.QPushButton('등록')          #등록 버튼
        self.cancelButton = QtWidgets.QPushButton('취소')          #취소 버튼
        ...
        vbox.addWidget(self.title)                       #수직 박스
        vbox.addStretch(1.5)
...
class MainWindow(QMainWindow):
    ...
    def secondWindow(self) :
        ...
        #self.second.pushButton.clicked.connect(self.startUI)
        self.show()
